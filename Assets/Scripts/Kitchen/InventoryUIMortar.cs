...
public class InventoryUIMortar : MonoBehaviour
{
    ...
    private void Start()
    {
        _spawnPoint = GameObject.Find("MortarSpawnPoint").transform;
        InstantiateUI();
    }
    ...
    public void OnIconClicked(Ingredient ingredient, GameObject iconObject)
    {
        ...
        Instantiate(ingredient.iconGameObject, _spawnPoint.position, Quaternion.identity);
